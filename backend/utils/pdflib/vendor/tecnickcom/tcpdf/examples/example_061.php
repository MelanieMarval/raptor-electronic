...
<pre>$pdflib->SetCellPadding(0);</pre>
...
$pdflib->setHtmlVSpace($tagvs);</pre>
...
<pre>$pdflib->setCellHeightRatio(1.25);</pre>
...
<pre>$pdflib->setImageScale(0.47);</pre>
...
$pdf->Output('example_061.pdflib', 'I');
