...
$hyphen_patterns = $pdflib->getHyphenPatternsFromTEX('hyphens/hyph-en-gb.tex');

$html = $pdflib->hyphenateText($html, $hyphen_patterns, array(), 1, 2, 1, 8);
*/
...
$pdf->Output('example_046.pdflib', 'I');
