...
if (isset($btnBorrar)) {
    ...
    $delete->deleteEmployee($employeeCi);
}
?>

<!-- DELETE ADMIN MODAL -->
<span hidden id="showModal"><?php if (isset($_GET['modal'])) echo $_GET['modal']?></span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" class="modal-content">
            ...
            <div class="modal-body" id="modalBody">
                <p id="admin" ><?php if (isset($_GET['name'])) echo $_GET['name'] ?></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button value="btnBorrar" type="submit" class="btn btn-danger"">Eliminar</button>
            </div>
        </form>
    </div>
</div>
